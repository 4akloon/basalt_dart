...
/// Backend-agnostic core behind the `ext.basalt.*` service extensions.
///
/// Every method operates purely through the [Connection] interface and the
/// [BasaltDevTools] registry, so it is directly unit-testable without a VM
...
final class InspectorService {
  ...
  String _backend(String id) {
    for (final i in BasaltDevTools.instances) {
